package son.dev.app.livewallpaper.config;

import son.dev.app.livewallpaper.model.Wallpaper;
import son.dev.app.livewallpaper.remote.IComputerVision;
import son.dev.app.livewallpaper.remote.RetrofitClient;
...
public class Common {
    ...
    // API
    public static final String BASE_URL = "https://sondevtest.cognitiveservices.azure.com/vision/v3.0/";
